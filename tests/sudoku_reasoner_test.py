...
def test_naked_singles_analysis(sudoku_reasoner: SudokuReasoner) -> None:
    sudoku_model: SudokuModel = SudokuModelRepository.get_random(candidate_type=SudokuModelCandidateType.ZEROTH_LAYER_NAKED_SINGLES)
...
def test_hidden_singles_analysis(sudoku_reasoner: SudokuReasoner) -> None:
    sudoku_model: SudokuModel = SudokuModelRepository.get_random(candidate_type=SudokuModelCandidateType.ZEROTH_LAYER_HIDDEN_SINGLES)
    sudoku: Sudoku = SudokuMapper.to_sudoku(sudoku_model)
    sudoku_reasoner.analyze(sudoku)
